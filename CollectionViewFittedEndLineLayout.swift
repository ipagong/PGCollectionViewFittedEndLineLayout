...
/// A horizontal alignment used internally by `CollectionViewFittedEndLineLayout`
...
open class CollectionViewFittedEndLineLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: CollectionViewFittedEndLineLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: CollectionViewFittedEndLineLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: CollectionViewFittedEndLineLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: CollectionViewFittedEndLineLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: CollectionViewFittedEndLineLayout) {
    ...
    func alignVertically(collectionViewLayout: CollectionViewFittedEndLineLayout) {
